...
- Usuário individual que deseja gerenciar suas tarefas diárias
- Avaliadores acadêmicos que precisam verificar o uso de SDD e MVC
...
5. O código segue a arquitetura MVC documentada nas specs

---

## 5. Fase Atual

**Fase**: IMPLEMENT (Implementação)
